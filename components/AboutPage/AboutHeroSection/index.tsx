        ...
        <section className={styles.aboutHero}>
            ...
            <div className={styles.wrapper}>
                <div className={styles.text}>
                    <h2 ref={headingRef}>
                        {splitText("Over 8 years of experience, continuously pushing the boundaries of prouduct design and art direction.")}
                    </h2>
                    <h2 ref={heading2Ref}>
                        {splitText("Enthusiastic about crafting seamless experiences that combine ideas, visuals, design, and function.")}
                    </h2>
                </div>

                <div className={styles.image} ref={imageRef}>
                    <Image src='/images/about.jpeg' alt='Vimal das' width={500} height={500} unoptimized />
                </div>
            </div>
        </section>
    );
