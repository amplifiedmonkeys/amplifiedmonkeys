        ...
        <section className={styles.hero}>
            ...
            <div className={styles.marquee} ref={marqueeRef}>
                <div className={styles.content} ref={marqueeTextRef}>
                    &nbsp;amplified monkeys - amplified monkeys - amplified monkeys - amplified monkeys -
                    amplified monkeys - amplified monkeys - amplified monkeys - amplified monkeys -
                    amplified monkeys - amplified monkeys - amplified monkeys - amplified monkeys -
                    amplified monkeys - amplified monkeys - amplified monkeys - amplified monkeys -
                    amplified monkeys - amplified monkeys - amplified monkeys - amplified monkeys -
            ...
            an autonomous Creative Designer & Developer based in Bengaluru,passionate about Crafting Branding, UI/UX, and Product Design for Leading Global Companies and individuals
            </h5>
        </section>
    );
}