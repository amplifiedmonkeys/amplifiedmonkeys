    ...
    return (
        <section className={styles.about}>
            <div className={styles.container}>
                ...
                I am a dedicated designer and entrepreneur, passionate about transforming ideas into impactful realities. Through my brand, AmplifiedMonkeys, I create innovative designs that fuse artistry with purpose. My work is driven by a commitment to excellence, blending creativity and strategic vision to inspire and engage. Explore my journey and join me in shaping the future of design.
                </h2>
